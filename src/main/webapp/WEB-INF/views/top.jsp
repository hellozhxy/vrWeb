...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<!-- 
        <a class="navbar-brand" href="<%=path%>index.do"><h1><img src="images/logo.png" alt="" /></h1></a>
        -->
			<a class="navbar-brand" href="<%=path%>index.do"><h1>
					<img src="images/logo3.png" height="50px;" alt="蜂群在线平台" />
				</h1></a>
		</div>
						...
						<div class="signup">
							...
							<div class="continue-button">
								<a href="#small-dialog3"
									class="hvr-shutter-out-horizontal play-icon popup-with-zoom-anim">继续</a>
							</div>
						</div>
...
<div class="copyrights">
	Collect from <a href="http://www.vr.com/">蜂群在线平台</a>
</div>
 -->