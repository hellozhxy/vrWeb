...
public class ResumableInfo {
	...
	public boolean vaild() {
		if (resumableChunkSize < 0 || resumableTotalSize < 0 || UploadUtils.isEmpty(resumableIdentifier)
				|| UploadUtils.isEmpty(resumableFilename) || UploadUtils.isEmpty(resumableRelativePath)) {
			return false;
		} else {
			return true;
		}
